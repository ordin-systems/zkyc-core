...
ORDIN is the canonical maintainer and repository owner for this reference implementation.
...
- `v0.3.0` exists only as an integrated local candidate built forward from v0.2.1. Its executable baseline is `55d15981cf7f45e441205eb96f5aae79e58d00ae`.
...
This sanitized repository evidence does not preserve or imply the private demo application's full history, production deployment, customer use, or third-party adoption. It excludes fixed demo authentication, external-AI authority, webhooks, payment execution, private configuration, and unrelated assets.

## Rights record

The detailed transfer and rights record is retained privately. Source availability does not grant reuse rights unless ORDIN adds an explicit license.
