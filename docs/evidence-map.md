...
| Strict runtime-validated, request-correlated browser SDK | `packages/sdk/src/index.ts`, `packages/sdk/src/validation.ts`, `packages/sdk/src/integrity.ts` | 12 SDK tests, including credentialless denial and forged scope/context/policy/capability/affiliation/outcome/delegation/receipt/step-up response rejection |
