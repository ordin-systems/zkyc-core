...
At executable baseline `4a9bf5c17bf6ef4a2d35ce15b977308ef37f88ae`, the integrated local reference candidate supports these bounded claims:
...
- browser-compatible TypeScript SDK with strict exact-schema runtime validation and recomputed scope, context, policy, capability/affiliation satisfaction, outcome, delegation-binding, receipt, resolution, and step-up request/response correlation;
